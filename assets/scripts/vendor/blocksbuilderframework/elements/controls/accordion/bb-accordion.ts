...
/**
 * BBAccordion - Highly customizable Accordion control. Displays collapsible content panel
...
/**
 * Highly customizable Accordion control. Displays collapsible content panel 
 */
export class BBAccordion extends BBControl {
    constructor() {
        // Always call super first in constructor
        super(ControlTypeEnum.accordion);
    }
